                                        ...
                                        <table class="table">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="pro-title">Tổng</th>
                                                    <th class="pro-title">Phương thức</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <% ds = oo.getListOrderByUserID(UserID);
                                                        for (orders vv : ds) {%>
                                                    <td class="pro-title"><%=vv.getORDER_ID()%></td>
                                                    <td class="pro-title"><%=vv.getDATE()%></td>
                                                    <td class="pro-title">
