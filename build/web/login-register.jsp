<%-- 
    ...
    Created on : Aug 12, 2020, 3:44:39 PM
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb--30 mb-lg--0">
                            <!-- Login Form s-->
                            <form action="DangKy" name="signup_form" method="post" onsubmit="return validateSignUp()">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb--20">
                                            ...
                                            <input class="mb-0 form-control" type="email" id="email" name="email" placeholder="Nhập địa chỉ email tại đây..">
                                        </div>
                                        <div class="col-lg-6 mb--20">
                                            <label for="phone">Điện thoại</label>
                                            <input class="mb-0 form-control" type="number" id="phone" name="phone" placeholder="Nhập số điện thoại">
                                        </div>
                                        <div class="col-lg-6 mb--20">
                                            <label for="password">Mật khẩu</label>
                                            <input class="mb-0 form-control" type="password" id="password" name="password" placeholder="Nhập mật khẩu">
                                        </div>
                                        <div class="col-lg-6 mb--20">
                                            <label for="password">Xác minh mật khẩu</label>
                                            <input class="mb-0 form-control" type="password" id="repeat-password" name="repeat-password" placeholder="Nhập lại mật khẩu">
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                            <form action="DangNhap" name="login_form" method="post" onsubmit="return validateForm()">
                                <div class="login-form">
                                    <h4 class="login-title">Đăng nhập</h4>
                                    <p><span class="font-weight-bold">Tôi đã có tài khoản</span></p>
                                    <div class="row">
                                        <div class="col-md-12 col-12 mb--15">
                                        ...
                                        <div class="col-12 mb--20">
                                            ...
                                            <input class="mb-0 form-control" type="password" id="password1" name="password1" placeholder="Nhập mật khẩu">
                                        </div>
                                        <div class="col-md-12">
