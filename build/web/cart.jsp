<%-- 
    Document   : cart
    Created on : Aug 17, 2020, 3:06:04 PM
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="css/qty.css" />
                                    ...
                                    <div class="cart-table table-responsive mb--40">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <!-- Product Row -->
                                                <tr>
                                                    <td class="pro-remove"><a href="cartservlet?command=remove&product_id=<%=ds.getKey().getPRODUCT_ID()%>&cartID=<%=System.currentTimeMillis()%>"><i class="far fa-trash-alt"></i></a>
                                                    </td>
                                                    <td class="pro-thumbnail"><a href="#"><img
                                                                src="image/products/<%=ds.getKey().getIMAGE()%>" alt="Product"></a></td>
                                                    <td class="pro-title"><a href="#"><%=ds.getKey().getPRODUCT_NAME()%></a>
                                                        <p><i>(Mã sách: <%=ds.getKey().getPRODUCT_ID()%>)</i></p></td>
                                                    <td class="pro-price"><span><%=ds.getKey().getNEW_PRICE()%> VNĐ</span></td>
                                                    <td>
                                                        <div class="quantity buttons_added">
                                                            <a  href="cartservlet?command=sub&product_id=<%=ds.getKey().getPRODUCT_ID()%>&cartID=<%=System.currentTimeMillis()%>" class="minus">-</a>
                                                            <input type="number" name="quantity" value="<%=ds.getValue()%>" class="input-text qty text" size="4">
                                                            <a  href="cartservlet?command=plus&product_id=<%=ds.getKey().getPRODUCT_ID()%>&cartID=<%=System.currentTimeMillis()%>" class="plus">+</a>
                                                        </div>
                                                    </td>
                                                    <td class="pro-subtotal"><span><%=ds.getValue() * ds.getKey().getNEW_PRICE()%> VNĐ</span></td>
                                                    <%
                                                        int val = ds.getValue() * ds.getKey().getNEW_PRICE();
                                                        total += val;
                                                    %>
                            ...
                            <div class="col-lg-6 col-12 d-flex">
                                <div class="cart-summary">
                                    <div class="cart-summary-wrap">
                                        <h4><span>Thành tiền hóa đơn</span></h4>
                                        <p>Tổng tiền<span class="text-primary"><%=total%> VNĐ</span></p>
                                        <%
                                            int shipfee = 0;
                                        ...
                                        %>
                                        <p>Phí vận chuyển<span class="text-primary"><%=shipfee%> VNĐ</span></p>
                                        <h2>Thành tiền<span class="text-primary"><%=total + shipfee%> VNĐ</span></h2>
                                    </div>
                                    <% if (total == 0) {%>
                                    <div class="cart-summary-button">
                                        <a href="cart.jsp" onclick="nonetotal()" class="checkout-btn c-btn btn--primary">Thanh toán</a>
                                    </div>
                                    <%} else {%>
                                    <div class="cart-summary-button">
                                        <a href="checkout.jsp" class="checkout-btn c-btn btn--primary">Thanh toán</a>
                                    </div>
                                    <%}%>
                                </div>
                            </div>
