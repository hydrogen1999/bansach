<%-- 
    Document   : contact
    Created on : Aug 12, 2020, 3:43:27 PM
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="contact_form">
                                <h3 class="ct_title">Gửi thông điệp phản hồi</h3>
                                <form id="contact-form" action="newmessage" method="post" class="contact-form">
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-btn">
                                                <button type="submit" value="submit" id="submit" class="btn btn-success w-100"
                        ...
                        <div class="col-lg-3 col-sm-6 col-12 mb-30">
                            <div class="contact-info">
                                ...
                                <div class="content">
                                    ...
                                    <p>nguyencongthinh1999@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        <!--Contact Information End-->
                        ...
                        <div class="col-lg-3 col-sm-6 col-12 mb-30">
                            <div class="contact-info">
                                ...
                                <div class="content">
                                    ...
                                    <p>Thắng Lợi, La Phù, Hoài Đức, Hà Nội</p>
                                </div>
                            </div>
                        </div>
                        <!--Contact Information End-->
                            ...
                            <div class="contact-info">
                                ...
                                <div class="content">
                                    ...
                                    <ul class="social-list list-inline">
                                        <li class="single-social facebook"><a href="https://www.facebook.com/thinh.nguyencong.9887/"><i class="ion ion-social-facebook"></i></a></li>
                                        <li class="single-social twitter"><a href="https://twitter.com/ThinhNguyenCong"><i class="ion ion-social-twitter"></i></a></li>
                                        <li class="single-social google"><a href="http://google.com/"><i class="ion ion-social-googleplus-outline"></i></a></li>
                                        <li class="single-social youtube"><a href="https://www.youtube.com/channel/UC1idwlskwZxGU_064h2NOUg?view_as=subscriber"><i class="ion ion-social-youtube"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
