...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Đơn hàng đang giao</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="adminshippingorder.jsp">Đơn hàng đang giao hàng</a>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" onclick="myFunction()" href="#">Đơn hàng đang giao hàng</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="2" align="center">
                                                    <a href="adminprocessorder?status=shipped&ORDER_ID=<%=vv.getORDER_ID()%>" class="btn btn-success">Xác nhận giao hàng</a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
