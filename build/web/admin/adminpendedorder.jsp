                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="adminpendedorder.jsp">Đơn hàng đã xử lý</a>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" onclick="myFunction()" href="#">Đơn hàng đã xử lý</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Danh sách đơn hàng đã xử lý</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="2" align="center">
                                                    <a href="adminprocessorder?status=shipping&ORDER_ID=<%=vv.getORDER_ID()%>" class="btn btn-success">Gửi đi</a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
