...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Danh sách sản phẩm</title>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminlistproduct">Danh sách sản phẩm</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages6" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item" href="adminlistreview">Danh sách bình luận</a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminnewproduct" method="post"> 
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input class="form-control" type="text" name="PRODUCT_ID" size="3"/></td>
                                                <td><input class="form-control" type="text" name="PRODUCT_NAME" size="25"/></td>
                                                <td><input class="form-control" type="text" name="PRICE" size="10"/></td>
                                                <td><input class="form-control" type="text" name="DISCOUNT" size="3"/></td>
                                                <td><textarea class="form-control" type="text" name="OTHER" size="50"></textarea></td>
                                                <td><input class="form-control" type="text" name="NUMBER" size="3"/></td>
                                                <td><select class="form-control" name="AUTHOR_ID">
                                                        <%! authorDAO v11 = new authorDAO();
                                                            List<author> ds56 = new ArrayList<>();%>
                                                        <% ds56 = v11.getListAuthor();%>
                                                        <% for (author c : ds56) {%>
                                                        <option value="<%=c.getAUTHOR_ID()%>"><%=c.getAUTHOR_NAME()%></option>
                                                        <%}%>
                                                    </select></td>
                                                ...
                                                <td><input class="form-control" type="text" name="STATUS" size="3"/></td>
                                                <td><textarea class="form-control" type="text" name="DESCRIPTION" size="50"></textarea></td>
                                                <td><input class="form-control" type="text" name="IMAGE" size="10"/></td>
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="PD" items="${listProduct}">
                                                <tr>
                                                    <td><c:out value="${PD.PRODUCT_ID}" /></td>
                                                    <td><c:out value="${PD.PRODUCT_NAME}" /></td>
                                                    <td><c:out value="${PD.PRICE}" /></td>
                                                    <td><c:out value="${PD.DISCOUNT}" /></td>
                                                    <td><c:out value="${PD.OTHER}" /></td>
                                                    <td><c:out value="${PD.NUMBER}" /></td>
                                                    <td><c:out value="${PD.AUTHOR_NAME}" /></td>
                                                    <td><c:out value="${PD.CATEGORY_NAME}" /></td>
                                                    <td><c:out value="${PD.STATUS}" /></td>
                                                    <td><c:out value="${PD.DESCRIPTION}" /></td>
                                                    <td>
                                                        <a title="Edit" href="admineditproduct?PRODUCT_ID=<c:out value='${PD.PRODUCT_ID}' />" class="btn btn-info btn-circle"><i class="fas fa-info-circle"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a title="Delete" href="admindeleteproduct?PRODUCT_ID=<c:out value='${PD.PRODUCT_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
