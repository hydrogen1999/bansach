...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Sửa thông tin tác giả</title>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    <a class="nav-link collapsed active" href="#" data-toggle="collapse" data-target="#collapsePages4" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-folder"></i>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Sửa thông tin tác giả</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="adminupdateauthor" method="post"> 
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input class="form-control" type="text" name="AUTHOR_ID" size="5"
                                                               value="<c:out value='${AT.AUTHOR_ID}' />"/>
                                                    </td>
                                                    <td><input class="form-control" type="text" name="AUTHOR_NAME" size="25"
                                                               value="<c:out value='${AT.AUTHOR_NAME}' />"/>
                                                    </td>
                                                    <td><input class="form-control" type="text" name="OTHER_AUTHOR" size="25"
                                                               value="<c:out value='${AT.OTHER_AUTHOR}' />"/>
                                                    </td>
