<%-- 
    Document   : adminhome
    Created on : Aug 29, 2020, 9:55:17 PM
...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Tài khoản</title>
                        ...
                        <div class="container emp-profile">
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <i class="profile-edit-btn"><a href="editadmininfo?ADMIN_ID=<%=AdminID%>">Sửa thông tin</a></i>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="profile-work">
                                            <p>THINHNGUYENCONG BOOKSTORE</p>
                                            <a href="" ><i class="fas fa-google"> Website</i></a><br/>
                                            <a href=""><i class="fas fa-facebook-square"> Fanpage Facebook</i></a><br/>
                                        ...
                                        <div class="tab-content profile-tab" id="myTabContent">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <p><i class="fas fa-phone"> <%=AdminPhone%></i></p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
