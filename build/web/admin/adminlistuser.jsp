...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Danh sách khách hàng</title>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminlistuser">Danh sách khách hàng</a>
                        </div>
                    </div>
                </li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminnewuser" method="post"> 
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input class="form-control" type="text" name="USER_ID" size="5"/>
                                                </td>
                                                <td><input class="form-control" type="text" name="USER_NAME" size="25"/>
                                                </td>
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="US" items="${listUser}">
                                                <tr>
                                                    <td><c:out value="${US.USER_ID}" /></td>
                                                    <td><c:out value="${US.USER_NAME}" /></td>
                                                    <td><c:out value="${US.EMAIL}" /></td>
                                                    <td><c:out value="${US.PHONE}" /></td>
                                                    <td><c:out value="${US.PASSWORD}" /></td>
                                                    <td>
                                                        <a title="Edit" href="adminedituser?USER_ID=<c:out value='${US.USER_ID}' />" class="btn btn-info btn-circle"><i class="fas fa-info-circle"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a title="Delete" href="admindeleteuser?USER_ID=<c:out value='${US.USER_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
