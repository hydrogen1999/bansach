<%-- 
    Document   : checkout
    Created on : Aug 12, 2020, 3:42:28 PM
                                        ...
                                        <div id="billing-form" class="mb-40">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb--20">
                                                    ...
                                                    <p name="user_id" value="<%=UserID%>"><b><%=UserID%></b></p>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12 mb--20">
                                                    ...
                                                    <p name="phone" value="<%=Phone%>"><b><%=Phone%></b></p>
                                                </div>
                                                <div class="col-12 mb--20">
                                                    <label>Tình trạng đơn hàng</label>
                                                    <p name="status" value="Đặt mua"><b>Đặt mua</b></p>
                                                </div>
                                                <div class="col-12 mb--20">
                                                    <label>Ngày đặt mua</label>
                                                    <p name="ngaydatmua" value="<%=date%>"><b><%=date%></b></p>
                                                </div>
                                                <div class="col-12 mb--20">
                                                ...
                                                <div class="col-12 col-12 mb--20">
                                                    ...
                                                    <select name="method" class="nice-select">
                                                        <option value="Trả bằng tiền mặt" >Trả bằng tiền mặt</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="checkout-cart-total">
                                                    ...
                                                    <ul>
                                                        <li><span class="left"><%=ds.getKey().getPRODUCT_NAME()%> X <b> <%=ds.getValue()%></b></span> <span
                                                                class="right"><%=ds.getValue() * ds.getKey().getNEW_PRICE()%> VNĐ</span></li>
                                                    </ul>
                                                    <%
                                                        int val = ds.getValue() * ds.getKey().getNEW_PRICE();
                                                        total += val;
                                                    ...
                                                    <%
                                                        ...
                                                        ss.setAttribute("totalmoney", total + shipfee);
                                                    %>
                                                    <p>Phí vận chuyển <span><%=shipfee%> VNĐ</span></p>
                                                    <h4 name="total" value="<%=total + shipfee%>">Thành tiền<span><%=total + shipfee%> VNĐ</span></h4>
                                                    <div class="method-notice mt--25">
                                                        <article>
                                                            <h3 class="d-none sr-only">blog-article</h3>
                                                            Đơn hàng thường được giao trong vòng 3 - 5 ngày.
                                                            Xin cảm ơn!
                                                        </article>
                                                    </div>
                                                    <div class="term-block">
                                                        <input type="checkbox" id="accept_terms2">
                                                        <label for="accept_terms2">Tôi đồng ý với các điều khoản sử dụng.</label>
                                                    </div>
