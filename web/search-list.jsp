                            ...
                            <div class="shop-product-wrap grid with-pagination row space-db--30 shop-border">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-card">
                                        ...
                                        <% Object PRODUCT_NAME1 = session.getAttribute("product_name");%>
                                        <%
                                            if (PRODUCT_NAME1 != null) {
                                                String PRODUCT_NAME = PRODUCT_NAME1.toString();
                                                product ds88 = v1.selectProductName(PRODUCT_NAME);
                                                if (ds88 != null) {%>
                                        <div class="product-grid-content">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.jsp"><%=ds88.getPRODUCT_NAME()%></a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                                    <a href="product-details.jsp?product_id=<%=ds88.getPRODUCT_ID()%>"><span style="width: 255px; height: 400px"><img src="image/products/<%=ds88.getIMAGE()%>" alt=""></span></a>
                                                    <div class="hover-contents">
                                                        <a href="product-details.jsp" class="hover-image">
                                                            <a href="product-details.jsp?product_id=<%=ds88.getPRODUCT_ID()%>"><span style="width: 255px; height: 400px"><img src="image/products/<%=ds88.getIMAGE()%>" alt=""></span></a>
                                                        </a>
                                                        <div class="hover-btns">
                                                            <a href="cartservlet?command=insert&product_id=<%=ds88.getPRODUCT_ID()%>&cartID=<%=System.currentTimeMillis()%>" class="single-btn">
                                                ...
                                                <div class="price-block">
                                                    <span class="price"><%=ds88.getNEW_PRICE()%> VNĐ</span><br>
                                                    <del class="price-old"><%=ds88.getPRICE()%> VNĐ</del>
                                                    <span class="price-discount"><%=ds88.getDISCOUNT()%> %</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-list-content">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="product-details.jsp" tabindex="0"><%=ds88.getPRODUCT_NAME()%></a></h3>
                                                </div>
                                                <article>
                                                ...
                                                <div class="rating-block">
                                                    ...
                                                    <p>Đánh giá: <%=df.format(v33.AVG_RATE(ds88.getPRODUCT_ID()))%> / 5,0 <span class="fas fa-star star_on"></span></p>
                                                </div>
                                                <div class="btn-block">
                                                    <a href="cartservlet?command=insert&product_id=<%=ds88.getPRODUCT_ID()%>&cartID=<%=System.currentTimeMillis()%>" class="btn btn-outlined">Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        <%} else {%>
                                        <center>Không tìm thấy kết quả</center>
                                            <%}%>
                                            <%} else {%>
                                        <center>Không tìm thấy kết quả</center>
                                            <%}%>
