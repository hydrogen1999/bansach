...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Đơn hàng bị hủy</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="adminremoveorder.jsp">Đơn hàng bị hủy</a>
                        </div>
                    </div>
                </li>
                <%} else {%>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" onclick="myFunction()" href="#">Đơn hàng bị hủy</a>
                        </div>
                    </div>
                </li>
                <%}%>
