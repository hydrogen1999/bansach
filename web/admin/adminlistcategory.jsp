...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Danh sách thể loại</title>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminlistcategory">Danh sách thể loại</a>
                        </div>
                    </div>
                </li>
                <!-- Nav Item - Tables -->
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminnewcategory" method="post"> 
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input class="form-control" type="text" name="CATEGORY_ID" size="5"/>
                                                </td>
                                                <td><input class="form-control" type="text" name="CATEGORY_NAME" size="25"/>
                                                </td>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="CG" items="${listCategory}">
                                                <tr>
                                                    <td><c:out value="${CG.CATEGORY_ID}" /></td>
                                                    <td><c:out value="${CG.CATEGORY_NAME}" /></td>
                                                    <td>
                                                        <a title="Edit" href="admineditcategory?CATEGORY_ID=<c:out value='${CG.CATEGORY_ID}' />" class="btn btn-info btn-circle"><i class="fas fa-info-circle"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a title="Delete" href="admindeletecategory?CATEGORY_ID=<c:out value='${CG.CATEGORY_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
