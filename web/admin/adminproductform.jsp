...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Sửa thông tin sản phẩm</title>
                                ...
                                <div class="table-responsive">
                                    <form action="adminupdateproduct" method="post"> 
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input class="form-control" type="text" name="PRODUCT_ID" size="5"
                                                               value="<c:out value="${PD.PRODUCT_ID}" />"/>
                                                    </td>
                                                    <td><input class="form-control" type="text" name="PRODUCT_NAME" size="25"
                                                               value="<c:out value='${PD.PRODUCT_NAME}' />"/>
                                                    </td>
                                                    <td><input class="form-control" type="text" name="PRICE" size="10"
                                                               value="<c:out value="${PD.PRICE}" />"/></td>
                                                    <td><input class="form-control" type="text" name="DISCOUNT" size="3"
                                                               value="<c:out value="${PD.DISCOUNT}" />"/></td>
                                                    <td><input class="form-control" type="text" name="OTHER" size="50"
                                                               value="<c:out value="${PD.OTHER}" />"/></td>
                                                    <td><input class="form-control" type="text" name="NUMBER" size="3"
                                                               value="<c:out value="${PD.NUMBER}" />"/></td>
                                                    ...
                                                    <td><input class="form-control" type="text" name="STATUS" size="3"
                                                               value="<c:out value="${PD.STATUS}" />"/></td>
                                                    <td><input class="form-control" type="text" name="DESCRIPTION" size="50"
                                                               value="<c:out value="${PD.DESCRIPTION}" />"/></td>
                                                    <td><input class="form-control" type="text" name="IMAGE" size="10"
                                                               value="<c:out value="${PD.IMAGE}" />"/></td>
