...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Danh sách tài khoản</title>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="adminlistaccount">Danh sách tài khoản</a>
                        </div>
                    </div>
                </li>
                            ...
                            <div class="card-body">
                                <form action="adminnewaccount" method="post"> 
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input class="form-control" type="text" name="ADMIN_ID" size="5"/>
                                                </td>
                                                <td><input class="form-control" type="text" name="ADMIN_NAME" size="25"/>
                                                </td>
                                                <td><input class="form-control" type="email" name="EMAIL" size="35"/>
                                                </td>
                                                <td><input class="form-control" type="number" name="PHONE" size="15"/>
                                                </td>
                                                <td><input class="form-control" type="text" name="PASSWORD" size="15"/>
                                                </td>
                                                <td>
                                                    <input type="radio" name="TYPE" size="10" value="Admin"> Admin
                                                    &nbsp;&nbsp;
                                                    <input type="radio" name="TYPE" size="10" value="Manager"> Manager
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="AM" items="${listAdmin}">
                                                <tr>
                                                    <td><c:out value="${AM.ADMIN_ID}" /></td>
                                                    <td><c:out value="${AM.ADMIN_NAME}" /></td>
                                                    <td><c:out value="${AM.EMAIL}" /></td>
                                                    <td><c:out value="${AM.PHONE}" /></td>
                                                    <td><c:out value="${AM.PASSWORD}" /></td>
                                                    <td><c:out value="${AM.TYPE}" /></td>
                                                    <td>
                                                        <a title="Edit" href="admineditaccount?ADMIN_ID=<c:out value='${AM.ADMIN_ID}' />" class="btn btn-info btn-circle"><i class="fas fa-info-circle"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a title="Delete" href="admindeleteaccount?ADMIN_ID=<c:out value='${AM.ADMIN_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
