...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Sửa thông tin thể loại</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Sửa thông tin thể loại</h6>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input class="form-control" type="text" name="CATEGORY_ID" size="5"
                                                               value="<c:out value='${CG.CATEGORY_ID}' />"/>
                                                    </td>
                                                    <td><input class="form-control" type="text" name="CATEGORY_NAME" size="25"
                                                               value="<c:out value='${CG.CATEGORY_NAME}' />"/>
                                                    </td>
