            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages5" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminlistmessage">Danh sách phản hồi</a>
                        </div>
                    </div>
                </li>
                <!-- Nav Item - Tables -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="MS" items="${listMessage}">
                                                <tr>
                                                    <td><c:out value="${MS.MESS_ID}" /></td>
                                                    <td><c:out value="${MS.EMAIL}" /></td>
                                                    <td><c:out value="${MS.MESSAGE}" /></td>
                                                    <td>
                                                        <a title="Delete" href="admindeletemessage?MESS_ID=<c:out value='${MS.MESS_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
