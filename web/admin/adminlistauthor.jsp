            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages4" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminlistauthor">Danh sách tác giả</a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminnewauthor" method="post"> 
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input class="form-control" type="text" name="AUTHOR_ID" size="5"/>
                                                </td>
                                                <td><input class="form-control" type="text" name="AUTHOR_NAME" size="25"/>
                                                </td>
                                                <td><textarea class="form-control" type="text" name="OTHER_AUTHOR" size="50"></textarea></td>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="AT" items="${listAuthor}">
                                                <tr>
                                                    <td><c:out value="${AT.AUTHOR_ID}" /></td>
                                                    <td><c:out value="${AT.AUTHOR_NAME}" /></td>
                                                    <td><c:out value="${AT.OTHER_AUTHOR}" /></td>
                                                    <td>
                                                        <a title="Edit" href="admineditauthor?AUTHOR_ID=<c:out value='${AT.AUTHOR_ID}' />" class="btn btn-info btn-circle"><i class="fas fa-info-circle"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a title="Delete" href="admindeleteauthor?AUTHOR_ID=<c:out value='${AT.AUTHOR_ID}' />" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
