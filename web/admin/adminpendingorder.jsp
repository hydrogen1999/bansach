<%-- 
    Document   : adminpendingorder
    Created on : Sep 1, 2020, 12:19:00 PM
...
<html lang="en">
    ...
    <head>
        ...
        <title>TNC Bookstore - Đơn hàng đã xử lý</title>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" href="adminpendingorder.jsp">Đơn hàng chờ xử lý</a>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Chức năng:</h6>
                            <a class="collapse-item active" onclick="myFunction()" href="#">Đơn hàng chờ xử lý</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Danh sách đơn hàng chờ xử lý</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                %>
                                                <% ds = oo.getListOrder(STATUS);
                                                        for (orders vv : ds) {%>
                                                <td><%=vv.getORDER_ID()%></td>
                                                <td><%=vv.getUSER_NAME()%></td>
                                                <td><%=vv.getDATE()%></td>
                                                <td>
                                                    <% order_detailDAO vo = new order_detailDAO();%>
                                                    <% List<order_complete> ds5 = new ArrayList<>();%>
                                                    <% ds5 = vo.getListOrderDetail(vv.getORDER_ID());%>
                                                    <ul>
                                                        <% for (order_complete cc : ds5) {%>
                                                        <li><%=cc.getPRODUCT_NAME()%> x <b><%=cc.getQUANTITY()%></b></li>
                                                            <%}%>
                                                    </ul>
                                                </td>
                                                <td class="pro-title"><%=vv.getTOTAL()%> VNĐ</td>
                                                <td class="pro-title"><%=vv.getMETHOD()%></td>
                                                <td class="pro-title"><%=vv.getDIACHI()%></td>
                                                <td class="pro-title"><%=vv.getSTATUS()%></td>
                                                <td colspan="2" align="center">
                                                    <a href="adminprocessorder?status=pended&ORDER_ID=<%=vv.getORDER_ID()%>" class="btn btn-success">Xử lý</a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a href="adminprocessorder?status=remove&ORDER_ID=<%=vv.getORDER_ID()%>" class="btn btn-danger">Hủy đơn</a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
